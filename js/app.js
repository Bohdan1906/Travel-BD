(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".destination-slider__slider-body")) new swiper_core_Swiper(".destination-slider__slider-body", {
                ...
                speed: 800,
                pagination: {
                    el: ".destination-slider__pagination",
                    type: "fraction",
                    clickable: true
                },
                navigation: {
                    prevEl: ".destination-slider__button-prev",
                    nextEl: ".destination-slider__button-next"
                },
                on: {}
            });
            if (document.querySelector(".reviews-page__slider-body")) new swiper_core_Swiper(".reviews-page__slider-body", {
        ...
        const script_text = document.getElementById("text");
        const script_option = document.getElementsByClassName("trawel-select__option");
        selectBtn.addEventListener("click", (function() {
            selectBtn.classList.toggle("active");
        }));
        for (const options of script_option) options.onclick = function() {
            script_text.innerHTML = this.textContent;
